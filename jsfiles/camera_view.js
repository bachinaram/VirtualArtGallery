...
AFRAME.registerComponent('rotation-reader', {
  tick: function () {
    ...
    //console.log(myStartPosition_x,myStartPosition_z,myBeta,myLength)
    if(((myStartPosition_x<camera_right_x)&&(myStartPosition_x>camera_left_x)) && (myStartPosition_z<camera_forward_z)){
      let new_values = getValuesFromPathGen(myStartPosition_x,myStartPosition_z,myStartBeta,myLength)
